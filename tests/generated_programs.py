...
from clingo.symbol import Function as _Function
from clingo.symbol import Number as _Number

from eclingo.solver.candidate import Assumptions, Candidate
from tests.programs_helper import Program

# This file contains generated module-level test data; the library used to
# create the symbols below is created here as an exception.
_lib = Library()
lib = _lib


def Function(*args):
    return _Function(_lib, *args)


def Number(*args):
    return _Number(_lib, *args)
