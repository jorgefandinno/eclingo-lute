...
def generate(lib, program):
    program = parse_program(lib, program)
    candidate_generator = GeneratorReification(lib, config, program)
...
class TestEclingoGeneratorReification(TestCase):
    def test_generator_programs(self):
        ...
        self.assert_models(
            ...
            [
                # Candidate(pos=[], neg=[Function(self.lib, 'k', [Function(self.lib, 'u', [Function(self.lib, 'b', [], True)], True)], True),
                #                        Function(self.lib, 'k', [Function(self.lib, 'u', [Function(self.lib, 'a', [], False)], True)], True)]),
                # Candidate(pos=[Function(self.lib, 'k', [Function(self.lib, 'u', [Function(self.lib, 'b', [], True)], True)], True)],
                #           neg=[Function(self.lib, 'k', [Function(self.lib, 'u', [Function(self.lib, 'a', [], False)], True)], True)]),
                Candidate(
                    pos=[
                        Function(
                            self.lib,
